...
- 4 nouvelles mascottes : le tirage aléatoire se fait maintenant parmi 21 images.

### v1.2.33

#### Spec Reminder

- Nouvelle mascotte : le tirage aléatoire se fait maintenant parmi 17 images.

### v1.2.32

#### Spec Reminder

- Nouvelle mascotte : le tirage aléatoire se fait maintenant parmi 16 images.
...
- Nouvelle mascotte : le tirage aléatoire du popup se fait maintenant parmi 15 images.
...
- La mascotte du popup est maintenant tirée au hasard parmi 5 images, sans jamais montrer la même deux fois de suite.
...
- Position de la fenêtre mémorisée définitivement (survit aux /reload et reconnexions).
...
#### Spec Reminder (nouveau module)

- Rappel de spécialisation à l'entrée en donjon Mythique (0/+) ou en raid, et à chaque Ready Check.
- Affiche la spé actuelle et la configuration de talents active si plusieurs sont enregistrées.
- Popup avec mascotte dédiée, confirmation explicite requise.
