...
local frFR = {
    ...
    rgGuildChooseButton = "Choisir...",
    rgGuildPickerTitle = "Choisir des membres de la guilde",
    rgGuildSelectAll = "Tout cocher (filtré)",
    rgGuildSelectNone = "Tout décocher (filtré)",
    rgGuildPickedCount = "%d sélectionné(s)",
...
local enUS = {
    ...
    rgGuildChooseButton = "Choose...",
    rgGuildPickerTitle = "Choose guild members",
    rgGuildSelectAll = "Select all (filtered)",
    rgGuildSelectNone = "Deselect all (filtered)",
    rgGuildPickedCount = "%d selected",
