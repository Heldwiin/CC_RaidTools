...
- Ajout de 2 nouvelles mascottes : le popup Spec Reminder et la fenêtre de pause tirent maintenant leur image au hasard parmi 23.
- Une mascotte existante a été remplacée par une nouvelle version.
...
- Ajout d'une nouvelle mascotte : le popup Spec Reminder et la fenêtre de pause tirent maintenant leur image au hasard parmi 17.

## 1.2.32

### Spec Reminder

- Ajout d'une nouvelle mascotte : le popup Spec Reminder et la fenêtre de pause tirent maintenant leur image au hasard parmi 16.
...
- Ajout d'une nouvelle mascotte : le popup tire maintenant son image au hasard parmi 15.
