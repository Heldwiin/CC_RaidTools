...
local function BuildUI(f)
    ...
    enabled:SetScript("OnClick",function(self) AutoPromoteDB.inviteTool.enabled=self:GetChecked() and true or false; if enabled._ccrtRefresh then enabled:_ccrtRefresh() end end)
